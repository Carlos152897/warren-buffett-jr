...
7. **`Perfil Inversionista/Carlos Rodriguez.md`** — eres el ÚNICO especialista que lee el perfil: evalúa tanto el riesgo de poseer esta empresa como el fit con el perfil del inversionista (capital $1K, máx 30–60% por posición, agresivo pero con horizonte 3–5 años, solo EE.UU., sin forex)
